...
python ../../atom3d/pli/convert_pdbbind_from_hdf5_to_npz.py $RAWDIR $NPZDIR/pdbbind -i $IDXDIR --drop_h
...
for MAXNUMAT in 300 320 340 360 380 400 420 440 460 480 500 520 540 560 580 600; do
	...
	python ../../atom3d/pli/convert_pdbbind_from_hdf5_to_npz.py $RAWDIR $NPZDIR/pdbbind -i $IDXDIR --drop_h --maxnumat $MAXNUMAT
