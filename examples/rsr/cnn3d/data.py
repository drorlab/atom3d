...
class CNN3D_TransformRSR(object):
...
if __name__=="__main__":
    dataset_path = os.path.join(os.environ['RSR_DATA'], 'val')
    dataset = LMDBDataset(dataset_path, transform=CNN3D_TransformRSR(radius=10.0))
